...
Mã nguồn xử lý tương tác lưu trữ S3 nằm ở tệp **s3ReceiptStorageService.js** (đường dẫn: [s3ReceiptStorageService.js](file:///C:/My_Project/server/src/services/s3ReceiptStorageService.js)). 
...
Đoạn mã cấu hình cuộc gọi nằm ở tệp **ocrService.js** (đường dẫn: [ocrService.js](file:///C:/My_Project/server/src/services/ocrService.js)) tương tác với AWS Textract thông qua Command:
