...
- Kiểm thử, khắc phục lỗi và dọn dẹp mã nguồn trước khi kết thúc kỳ thực tập.

### Các công việc cần triển khai trong tuần này:

| Thứ | Công việc | Ngày bắt đầu | Ngày hoàn thành | Nguồn tài liệu |
| --- | --------- | ------------ | --------------- | -------------- |
| 2 | **Module hóa đơn và OCR**<br>- Tham gia phát triển module xử lý hóa đơn ở backend.<br>- Hỗ trợ xây dựng service tải ảnh hóa đơn lên Amazon S3 và tích hợp với hàng đợi OCR.<br>- Viết test cho các trường hợp upload thành công, upload thất bại và lỗi trong quá trình xác minh.<br>- Kiểm tra việc xử lý exception và phản hồi lỗi từ service lưu trữ hoặc hàng đợi. | 13/07/2026 | 13/07/2026 | <https://cloudjourney.awsstudygroup.com/8-fcjworkforce/> |
| 3 | **Review API và luồng xác minh**<br>- Hỗ trợ phát triển các API liên quan đến chức năng tạo và xử lý review.<br>- Xây dựng integration test cho toàn bộ luồng từ khi người dùng tạo review đến khi hệ thống xác minh và trả kết quả.<br>- Kiểm tra trạng thái dữ liệu, mã phản hồi và cách hệ thống xử lý các tình huống xác minh thất bại. | 14/07/2026 | 14/07/2026 | <https://cloudjourney.awsstudygroup.com/8-fcjworkforce/> |
| 4 | **Tìm kiếm và lọc nhà hàng**<br>- Tham gia phát triển tính năng tìm kiếm và lọc nhà hàng trong Phase 3.<br>- Viết integration test cho các chức năng xem danh sách, xem chi tiết và tìm kiếm nhà hàng trên môi trường local.<br>- Kiểm tra dữ liệu đầu vào, kết quả phân trang, bộ lọc và các trường hợp không tìm thấy dữ liệu. | 15/07/2026 | 15/07/2026 | <https://cloudjourney.awsstudygroup.com/8-fcjworkforce/> |
| 5 | **Authentication và giao diện mobile**<br>- Hỗ trợ xây dựng màn hình đăng nhập mobile tích hợp Amazon Cognito.<br>- Xử lý lỗi đăng nhập, trạng thái loading và điều hướng sau khi xác thực thành công.<br>- Tham gia phát triển màn hình Home, tab Thông báo và màn hình nhập thông tin dành cho người dùng mới.<br>- Phối hợp với thành viên backend để cập nhật luồng lưu hồ sơ theo quy trình đăng ký mới. | 16/07/2026 | 16/07/2026 | <https://cloudjourney.awsstudygroup.com/8-fcjworkforce/> |
| 6 | **Hoàn thiện giao diện và kiểm thử cuối**<br>- Chỉnh sửa giao diện Favorites, Splash Screen và cập nhật icon ứng dụng theo thiết kế chung.<br>- Rà soát tính thống nhất của giao diện, điều hướng và trạng thái hiển thị trên mobile.<br>- Hỗ trợ phát hiện, khắc phục lỗi trong giai đoạn kiểm thử cuối.<br>- Refactor, dọn dẹp mã nguồn và cùng nhóm kiểm tra lại các chức năng trước khi kết thúc đợt thực tập. | 17/07/2026 | 17/07/2026 | <https://cloudjourney.awsstudygroup.com/8-fcjworkforce/> |
...
- Rà soát chức năng, sửa lỗi và dọn dẹp mã nguồn để chuẩn bị kết thúc kỳ thực tập.
