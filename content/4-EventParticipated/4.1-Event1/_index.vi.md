...
Hai hình ảnh dưới đây được ghi lại trực tiếp trong thời gian tôi tham dự Event 1.

![Màn hình trình bày các bài tập workshop tại Event 1](/fcj-template/images/4-EventParticipated/4.1-Event1/event1-workshop-exercises.png)

*Hình 1: Nội dung workshop về Authentication, Bedrock Guardrails, IAM Permission Boundaries, MCP và Terraform.*

![Màn hình trình bày nội dung dữ liệu startup tại Event 1](/fcj-template/images/4-EventParticipated/4.1-Event1/event1-startup-data-session.png)

*Hình 2: Phiên chia sẻ về các chiều dữ liệu quan trọng khi đánh giá startup.*
